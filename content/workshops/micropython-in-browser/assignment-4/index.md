...
- You will use Mosquitto message broker that implements the MQTT protocol
...
In this step, you’ll connect the ESP32 to your Wi-Fi network so it can communicate with the MQTT broker.
